...
class JdbcClientRunRepositoryTest {
    ...
    void shouldFindRunById() {
        ...
        assertEquals(1, run.id(), "Should have returned run with id 1");
    }
    ...
    void shouldUpdateRun() {
        ...
        Run updatedRun = repository.findById(1);
        assertEquals("Monday Updated", updatedRun.title(), "Should have returned run with title Monday Updated");
    }
